...
export default function AdminDashboard() {
  ...
  useEffect(() => { checkAuth(); fetchRooms(); }, []);
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '40px 32px' }}>
        ...
        {loading ? (
          ...
          <div className="card" style={{ textAlign: 'center', padding: '60px', color: 'var(--text3)' }}><p>발표가 없습니다.</p></div>
        ) : (
  ...
  return (
    <div className="card" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, padding: '18px 24px' }}>
      ...
      <div style={{ display: 'flex', gap: 8, flexShrink: 0, alignItems: 'center' }}>
        ...
        <button onClick={onDelete} style={{ background: 'transparent', border: '1px solid rgba(232,52,28,0.2)', borderRadius: 'var(--radius)', color: 'var(--text3)', fontSize: 12, padding: '7px 12px', cursor: 'pointer', transition: 'all 0.15s', fontFamily: 'sans-serif' }}
